...
import static edu.wpi.first.wpilibj.frc2.command.CommandGroupBase.registerGroupedCommands;
import static edu.wpi.first.wpilibj.frc2.command.CommandGroupBase.requireUngrouped;
